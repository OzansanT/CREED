export function getElements() {
  return {
    ...
    sidebar: document.getElementById("sidebar"), sidebarToggle: document.getElementById("sidebarToggle"), canvasMenuBtn: document.getElementById("canvasMenuBtn"), componentsMenuBtn: document.getElementById("componentsMenuBtn"), canvasControlsPanel: document.getElementById("canvasControlsPanel"), componentsPanel: document.getElementById("componentsPanel"), addJsonCardBtn: document.getElementById("addJsonCardBtn"), openJsonFileBtn: document.getElementById("openJsonFileBtn"),
